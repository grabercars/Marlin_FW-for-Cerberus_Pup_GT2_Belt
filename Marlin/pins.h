...
****************************************************************************************/
    ...
    #define X_DIR_PIN          21
    //#define X_STOP_PIN         18  //ie; X_MAX_PIN
    ...
    #define FAN_PIN            -1 //4 - we are defining this pin in configuration_adv.h for extruder fan
    // Currently available pins on X1 are A1- pin 30, A2- pin 29, A4- pin 27 and TX1- pin 11

    // To Enable the Z_Probe we need to define the MAX and MIN Pins in the style of Mega2560
    #define X_MIN_PIN          -1
    #define X_MAX_PIN          18
    #define Y_MIN_PIN          -1
    #define Y_MAX_PIN          19
    ...
    //#define SDSS               24
     ...
     #define BTN_EN1 10  // <-- X1 to Viki ------------------------------
     #define BTN_EN2 28 // <-- X1 to Viki ------------------------------
 
     #define BTN_ENC 29 //29  //the click switch <-- X1 to Viki ------------------------------

     #define SDCARDDETECT 30    
